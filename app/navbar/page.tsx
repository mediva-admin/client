...
const DesktopNavbar = () => (
  <div className='sm:flex hidden h-[70px] w-screen bg-white px-[15%] items-center  font-montserrat border-b-[1px] justify-between border-b-[#00000098] absolute z-[10] top-0'>
    <Link href={'/'}>
...
const MobileMenu = () => (
  <div className='sm:hidden flex w-screen'>
    <Menu shadow='md'>
      <div className='w-full flex justify-between items-center py-[5px] px-[5%]'>
        <div className='flex flex-row items-center gap-3 '>
          <Image src={Logo} className='h-[35px] w-fit ' alt='Arrow' />
          <p className='font-bold text-black text-[1.6rem]'>Mediva</p>
        </div>
