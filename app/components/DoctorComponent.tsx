  ...
  return (
    <div>
      ...
      <Link href={'/profile/doctor'}>
        {' '}
        <div className='h-[200px] w-[600px] bg-[#CBE6E2] flex flex-row items-center shadow-lg hover:scale-105 transition-all duration-300 '>
          <div className='w-[30%]'>
            <Image
              src={DoctorImage}
          ...
          <div className='flex w-[70%] flex-col text-black justify-between px-[20px] p-[5px] gap-[20px]'>
            <div>
              ...
              <p className='mb-[10px]'>{speciality}</p>
