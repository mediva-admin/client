...
export default function Doctors() {
  ...
  const filteredDoctors = doctors.filter((doctor) => {
    if (selectedFilter === "Location") {
      ...
      return doctor.doctorName.toLowerCase().includes(searchQuery.toLowerCase());
    }
    return true;
  });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white pt-16">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <h2 className="text-2xl font-semibold mb-4">Showing results for {selectedFilter}</h2>
        <div className="grid grid-cols-2 gap-[20px] justify-center mb-[100px]">
